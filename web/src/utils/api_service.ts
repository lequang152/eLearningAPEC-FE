...
import { refreshUnexpriredToken } from "../redux/Slice/Auth/authSlice";
...
export class ApiService {
    ...
    public static async refreshToken() {
        ...
        const data = await axios.post(`${process.env.NEXT_PUBLIC_API}/auth/refresh`,{}, 
        {
            headers: header,
        })
    ...
    public static async getFullTestQuestions(param_0: any, param_1: any, page: number, header: object) {
        return axios
            .get(`${process.env.NEXT_PUBLIC_API}/survey/questions/${param_0}/${param_1}?page=${page}`, {
                headers: header,
            }
        )
    }
    ...
    public static submitAudioQuestion(accessToken: string, answerToken: string, state: AnswerState, header: object) {
        return axios
            .post(`${process.env.NEXT_PUBLIC_API}/survey/submit/${accessToken}/${answerToken}`, state, {
                headers: header,
            })
    }
}